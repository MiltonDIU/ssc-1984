...
class UsersApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new UserResource(User::with(['school', 'professions', 'division', 'district', 'upazila', 'roles'])->get());
    }
    ...
    public function show(User $user)
    {
        ...
        return new UserResource($user->load(['school', 'professions', 'division', 'district', 'upazila', 'roles']));
    }
