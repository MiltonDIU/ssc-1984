        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.countries.update", [$country->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('iso3') ? 'is-invalid' : '' }}" type="text" name="iso3" id="iso3" value="{{ old('iso3', $country->iso3) }}">
                    @if($errors->has('iso3'))
                        <div class="invalid-feedback">
                            {{ $errors->first('iso3') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('numeric_code') ? 'is-invalid' : '' }}" type="text" name="numeric_code" id="numeric_code" value="{{ old('numeric_code', $country->numeric_code) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('iso2') ? 'is-invalid' : '' }}" type="text" name="iso2" id="iso2" value="{{ old('iso2', $country->iso2) }}">
                    @if($errors->has('iso2'))
                        <div class="invalid-feedback">
                            {{ $errors->first('iso2') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('capital') ? 'is-invalid' : '' }}" type="text" name="capital" id="capital" value="{{ old('capital', $country->capital) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('currency_name') ? 'is-invalid' : '' }}" type="text" name="currency_name" id="currency_name" value="{{ old('currency_name', $country->currency_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('currency_symbol') ? 'is-invalid' : '' }}" type="text" name="currency_symbol" id="currency_symbol" value="{{ old('currency_symbol', $country->currency_symbol) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tld') ? 'is-invalid' : '' }}" type="text" name="tld" id="tld" value="{{ old('tld', $country->tld) }}">
                    @if($errors->has('tld'))
                        <div class="invalid-feedback">
                            {{ $errors->first('tld') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('native') ? 'is-invalid' : '' }}" type="text" name="native" id="native" value="{{ old('native', $country->native) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('subregion') ? 'is-invalid' : '' }}" type="text" name="subregion" id="subregion" value="{{ old('subregion', $country->subregion) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('timezones') ? 'is-invalid' : '' }}" type="text" name="timezones" id="timezones" value="{{ old('timezones', $country->timezones) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('translations') ? 'is-invalid' : '' }}" type="text" name="translations" id="translations" value="{{ old('translations', $country->translations) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="number" name="latitude" id="latitude" value="{{ old('latitude', $country->latitude) }}" step="0.00000001">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="number" name="longitude" id="longitude" value="{{ old('longitude', $country->longitude) }}" step="0.00000001">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('emoji') ? 'is-invalid' : '' }}" type="text" name="emoji" id="emoji" value="{{ old('emoji', $country->emoji) }}">
                    @if($errors->has('emoji'))
                        <div class="invalid-feedback">
                            {{ $errors->first('emoji') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('emoji_u') ? 'is-invalid' : '' }}" type="text" name="emoji_u" id="emoji_u" value="{{ old('emoji_u', $country->emoji_u) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wiki_data') ? 'is-invalid' : '' }}" type="text" name="wiki_data" id="wiki_data" value="{{ old('wiki_data', $country->wiki_data) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('flag') ? 'is-invalid' : '' }}" name="flag" id="flag" required>
                        ...
                        @foreach(App\Models\Country::FLAG_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('flag', $country->flag) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('flag'))
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active" required>
                        ...
                        @foreach(App\Models\Country::IS_ACTIVE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('is_active', $country->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
