                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('event_category') ? 'is-invalid' : '' }}" name="event_category_id" id="event_category_id" required>
                                        @foreach($event_categories as $id => $entry)
                                            <option value="{{ $id }}" {{ (old('event_category_id') ? old('event_category_id') : $event->event_category->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control timepicker {{ $errors->has('event_end_time') ? 'is-invalid' : '' }}" type="text" name="event_end_time" id="event_end_time" value="{{ old('event_end_time',$event->event_end_time) }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details" id="details">{!! old('details',$event->details) !!}</textarea>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 {{ $errors->has('district') ? 'is-invalid' : '' }}" name="district_id" id="district_id" required>
                                                @foreach($districts as $id => $entry)
                                                    <option value="{{ $id }}" {{ (old('district_id') ? old('district_id') : $event->district->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control {{ $errors->has('is_free') ? 'is-invalid' : '' }}" name="is_free" id="is_free">
                                                ...
                                                @foreach(App\Models\Event::IS_FREE_SELECT as $key => $label)
                                                    <option value="{{ $key }}" {{ old('is_free', $event->is_free) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $event->address) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" step="0.01" name="price" id="price" value="{{ old('price', $event->price) }}">
                                            @if($errors->has('price'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" step="0.01" name="spouse_amount" id="spouse_amount" value="{{ old('spouse_amount', $event->spouse_amount) }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control {{ $errors->has('driver_amount') ? 'is-invalid' : '' }}" type="number" step="0.01" name="driver_amount" id="driver_amount" value="{{ old('driver_amount', $event->driver_amount) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active" required>
                                                ...
                                                @foreach(App\Models\Event::IS_ACTIVE_SELECT as $key => $label)
                                                    <option value="{{ $key }}" {{ old('is_active', $event->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                                @endforeach
                                            </select>
