        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.schools.update", [$school->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('eiin') ? 'is-invalid' : '' }}" type="text" name="eiin" id="eiin" value="{{ old('eiin', $school->eiin) }}">
                    @if($errors->has('eiin'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $school->mobile) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('management') ? 'is-invalid' : '' }}" type="text" name="management" id="management" value="{{ old('management', $school->management) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mpo') ? 'is-invalid' : '' }}" type="text" name="mpo" id="mpo" value="{{ old('mpo', $school->mpo) }}">
                    @if($errors->has('mpo'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('post_office') ? 'is-invalid' : '' }}" type="text" name="post_office" id="post_office" value="{{ old('post_office', $school->post_office) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $school->address) }}</textarea>
