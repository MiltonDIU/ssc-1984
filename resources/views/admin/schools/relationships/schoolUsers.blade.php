    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-schoolUsers">
                    <thead>
                    <tr>
                        <th width="10">
                    ...
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                {{ App\Models\User::BLOOD_GROUP_SELECT[$user->blood_group] ?? '' }}
                            </td>
                            <td>
                                @can('user_show')
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-schoolUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
