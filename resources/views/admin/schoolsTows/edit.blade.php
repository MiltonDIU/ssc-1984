...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.schoolsTow.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.schools-tows.update", [$schoolsTow->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required" for="name">{{ trans('cruds.schoolsTow.fields.name') }}</label>
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $schoolsTow->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $schoolsTow->slug) }}">
                    @if($errors->has('slug'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $schoolsTow->district) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('upazila') ? 'is-invalid' : '' }}" type="text" name="upazila" id="upazila" value="{{ old('upazila', $schoolsTow->upazila) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('eiin') ? 'is-invalid' : '' }}" type="text" name="eiin" id="eiin" value="{{ old('eiin', $schoolsTow->eiin) }}">
                    @if($errors->has('eiin'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $schoolsTow->mobile) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('management') ? 'is-invalid' : '' }}" type="text" name="management" id="management" value="{{ old('management', $schoolsTow->management) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mpo') ? 'is-invalid' : '' }}" type="text" name="mpo" id="mpo" value="{{ old('mpo', $schoolsTow->mpo) }}">
                    @if($errors->has('mpo'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('post_office') ? 'is-invalid' : '' }}" type="text" name="post_office" id="post_office" value="{{ old('post_office', $schoolsTow->post_office) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $schoolsTow->address) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('is_approve') ? 'is-invalid' : '' }}" name="is_approve" id="is_approve">
                        ...
                        @foreach(App\Models\SchoolsTow::IS_APPROVE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('is_approve', $schoolsTow->is_approve) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active" required>
                        ...
                        @foreach(App\Models\SchoolsTow::IS_ACTIVE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('is_active', $schoolsTow->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
