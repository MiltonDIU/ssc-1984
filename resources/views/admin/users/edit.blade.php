    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input style="margin-top:28px" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" required>
                ...
                {{--                    <input class="form-control {{ $errors->has('id_ssc_bd') ? 'is-invalid' : '' }}" type="text" name="id_ssc_bd" id="id_ssc_bd" value="{{ old('id_ssc_bd', '') }}">--}}
                ...
                {{--                    <input class="form-control {{ $errors->has('id_ssc_district') ? 'is-invalid' : '' }}" type="text" name="id_ssc_district" id="id_ssc_district" value="{{ old('id_ssc_district', '') }}">--}}
