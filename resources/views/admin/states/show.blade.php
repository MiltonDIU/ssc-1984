        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.state.fields.flag') }}
                        </th>
                        <td>
                            {{ App\Models\State::FLAG_SELECT[$state->flag] ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.state.fields.is_active') }}
                        </th>
                        <td>
                            {{ App\Models\State::IS_ACTIVE_SELECT[$state->is_active] ?? '' }}
                        </td>
                    </tr>
                    </tbody>
                </table>
